...
# Uczenie maszynowe (Machine Learning) dla początkujących - kurs

> 🌍 Podróżuj po świecie poznając uczenie maszynowe z pomocą kultur z każdego zakątka globu 🌍

Ambasadorzy chmury Azure firmy Microsoft z przyjemnością prezentują 12 tygodniowy, składający się z 26 lekcji kurs o **Uczeniu Maszynowym**. W kursie tym nauczysz się o tak zwanym **klasycznym uczeniu maszynowym**, głównie wykorzystując bibliotekę Scikit-learn bez poruszania tematyki głębokiego uczenia (deep learning), które to zostanie poruszone w naszym przyszłym kursie "SI dla początkujących". Zachęcamy również do zapoznania się z naszym kursem ['Danologia (data science) dla początkujcych'](https://aka.ms/datascience-beginners)

Udaj się z nami w podróż do okoła świata, w czasie której będziemy stosować te klasyczne techniki do danych z różnych części globu. Każda lekcja zaczyna się i kończy quizem, posiada spisane polecenia do wykonania by ukończyć lekcję, zadanie do wykonania, rozwiaznie i wiele innych elementów. Nasze podejście bazujące na projektach, pozwoli Ci zdobywać wiedzę podczas tworzenia rozwiązań, dzięki czemu poznane techniki zostaną przez Ciebie lepiej i na dłużej przyswojone.

**✍️ Gorące podziękowania dla naszych autorów** Jen Looper, Stephen Howell, Francesca Lazzeri, Tomomi Imura, Cassie Breviu, Dmitry Soshnikov, Chris Noring, Anirban Mukherjee, Ornella Altunyan, oraz Amy Boyd

**🎨 Równieź wielkie podziękowania dla naszych ilustratorów** Tomomi Imura, Dasani Madipalli, oraz Jen Looper

**🙏 Specjalne podziękowania 🙏 dla autorów, współtwórców oraz recenzentów z naszego programu Microsoft Student Ambassador **, notably Rishit Dagli, Muhammad Sakib Khan Inan, Rohan Raj, Alexandru Petrescu, Abhishek Jaiswal, Nawrin Tabassum, Ioan Samuila, oraz Snigdha Agarwal

**🤩 Dodatkowe podziękowania dla Erica Wanju z programuMicrosoft Student Ambassador Eric Wanjau za stworzenie lekcji w języku R!**
